...
import com.ipManager.ipManager.api.responses.BasketStockResponse
...
class BasketStockController(
    ...
    @GetMapping
    fun getStock(): BasketStockResponse? {
        return basketStockService.getCurrentStock()?.let { BasketStockResponse.fromDto(it) }
    }
}
